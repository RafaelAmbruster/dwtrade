...
@RestController
@RequestMapping("/api/dw-trade-kafka")
public class DwTradeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DwTradeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DwTradeKafkaResource(KafkaProperties kafkaProperties) {
